  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <p className="mt-3 text-muted-foreground leading-7">
        hizlismsal.com, FerPay stoğunu gösterir. Sen hizmet seçince sunucu
        FerPay’den numara alır; SMS bu sitedeki gelen kutusuna yazılır.
      </p>
      <ol className="mt-8 list-decimal space-y-3 pl-5 text-sm leading-6">
        <li>ferpay.com.tr’de bakiye yükle.</li>
        <li>Hizmet ve ülke seç, kirala (bakiyen FerPay’den düşer).</li>
        <li>Numarayı hedef uygulamaya yaz.</li>
        <li>Kodu buradan kopyala. Gelmezse iptal et, iade FerPay’de olur.</li>
      </ol>
